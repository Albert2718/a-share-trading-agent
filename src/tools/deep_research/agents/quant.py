...
from ..tools import AkshareTools, LocalLSTMTool
from ..utils import clamp


PROJECT_ROOT = Path(__file__).resolve().parents[4]
DEFAULT_MODEL_PATH = PROJECT_ROOT / "artifacts" / "models" / "mymodel.pt"
DEFAULT_FALLBACK_DATA_PATH = PROJECT_ROOT / "experiments" / "train_data.npy"
